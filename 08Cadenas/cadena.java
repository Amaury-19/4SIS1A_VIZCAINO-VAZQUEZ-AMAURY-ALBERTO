...
public class cadena {
    ...
    //metodo de cadenas
    public void cadenas (){
        String s1 = "Hola habia una vez un patito que decia miau, y queria mimir; pero no lo dejaron y por eso estaba triste"
    
        System.out.println("El tamañp de la cadena es " + s1.length());
