    ...
    public void menu() {
        ...
        switch (opcion) {
            case 1:
                ...
                for (Persona objeto : listadepersonas) {
                    System.out.println("El id es: " + objeto.getId() + "\n"
                            ...
                            + "Su telefono es: " + objeto.geTTelefono() + "\n");
            ...
            case 2:
                ...
                System.out.println("Ingrese el telefono del dormidito: ");
                int telefonopersona = Integer.parseInt(entrada.nextLine());

                // guardarlo en el objeto correspondiente de persona
                Persona personaDormidito = new Persona(idpersona, nombrepersona, edadpersona, telefonopersona);
            ...
            case 3:
                ...
                System.out.println("La informacion del dormidito es: \n"
                        ...
                        + "Telefono: " + personabuscar.geTTelefono() + "\n");
                // cambio de los datos
