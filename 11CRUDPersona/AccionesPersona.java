...
public class AccionesPersona {
    ...
    public void agregarPersona(Persona p) {
        // voy a ocupar ami objeto de lsita de persona para invocar un metodo para
    ...
    public Persona buscarPersona(int id) {
        ...
        // necesito recorrer todo el arreglo de personas hasta encontrar el id que sea
        // id = parametro
    ...
    public void actualizarPersona(Persona actualizada) {
        // primero debeo de buscar a la persona creo mi instancia de la persona que voy
        // a buscar
